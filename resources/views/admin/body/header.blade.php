...
<form action="{{ route('adminsearch') }}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
    <div class="input-group">
        <input type="text" class="typeahead form-control bg-light border-0 small" placeholder="Chercher cours..."
            aria-label="Search" aria-describedby="basic-addon2" name="query" id="query">
...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow d-sm-none">
        ...
        <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
            ...
            <form action="{{ route('adminsearch') }}" method="GET" class="form-inline mr-auto w-100 navbar-search">
                <div class="input-group">
    ...
    <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <a class="dropdown-item" href="{{ route('adminprofile.view') }}">
