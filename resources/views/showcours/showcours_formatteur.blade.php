                            ...
                            <div class="col-8" style="width:100%; padding-left: 50px">
                                ...
                                <div class="row">
                                    <div style="height: auto; display: block">
                                        <p style="font-size: 17px; white-space: pre-wrap; font-style:italic; color:#5b6378">Formatteur : <a href="{{ route('formatteurprofile2', $showData->user['id']) }}">{{ $showData->user['name'] }}</a></p>
                                ...
                                <div class="card-body" style="border-radius:2px; padding-top: 50px; height:fit-content">
                                    <div class="row" style="padding-right: 40px">
                                        ...
                                        <p style="font-size: 18px; white-space: pre-wrap ;color: black;"><i class="fas fa-fw fa-book"></i>   <span>{{$showData->matiere['name']}}</span></p>
                                            ...
                                            <p style="font-size: 18px; white-space: pre-wrap ;color: black;"><i class="fas fa-fw fa-book-reader"></i>   <a href="{{ route('subscribersview2', $showData->id) }}"><span>{{$showData->enrolled_count}}</span></a></p>
                                            <p style="font-size: 18px; white-space: pre-wrap ;color: black;"><i class="fas fa-fw fa-comment"></i>   <a href="{{ route('commentsview2', $showData->id) }}"><span>Commentaires</span></a></p>
                                    </div>
                                </div>
                            </div> 
                        </div>
