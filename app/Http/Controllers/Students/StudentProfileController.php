...
class StudentProfileController extends Controller
{
    public function StudentProfileView(){
        ...
        return view('students.profile.view_profile', compact('user'));
    }
    ...
    public function StudentProfileStore(Request $request){
        ...
        $data->niveau_eleve = $request->niveau_eleve;
        ...
        return redirect()->route('studentprofile.view')->with($notification);
    }

    public function StudentPasswordView(){
        return view('students.profile.edit_password');
    }
