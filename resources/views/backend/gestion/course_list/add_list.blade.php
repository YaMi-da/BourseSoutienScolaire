	 	...
	 	@csrf
					  <div class="row" style="margin-left: 30px;">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="custom-field one">
									<input type="name" id="titre" name="titre" style="width: 400px;" required placeholder=" "/>
									<span class="placeholder">Titre <span class="text-danger">*</span></span>
								</label>
							</div>	
						</div>
                        	...
                        	<label for="matiere_id" class="custom-field one">
                            	<div class="select">
                                	<select name="matiere_id" id="matiere_id" required style="width: 400px;">
                                    	<option value="" selected="" disabled="">Matière <span class="text-danger">*</span></option>
                        	...
                        	<label for="niveau_id" class="custom-field one">
                            	<div class="select">
                                	<select name="niveau_id" id="niveau_id" required style="width: 400px;">
                                    	<option value="" selected="" disabled="">Niveau <span class="text-danger">*</span></option>
                        	...
                        	<label for="user_id" class="custom-field one">
                            	<div class="select">
                                	<select name="user_id" id="user_id" required style="width: 400px;">
                                    	<option value="" selected="" disabled="">Formatteur <span class="text-danger">*</span></option>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="debut_seance" class="custom-field one">
									<input type="datetime-local" id="debut_seance" name="debut_seance" style="width: 400px;" required placeholder=" "/>
									<span class="placeholder">Début de séance <span class="text-danger">*</span></span>
								</label>
							</div>	
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="fin_seance" class="custom-field one">
									<input type="datetime-local" id="fin_seance" name="fin_seance" style="width: 400px;" required placeholder=" "/>
									<span class="placeholder">Fin de séance <span class="text-danger">*</span></span>
								</label>
							</div>	
						</div>
						...
						<div class="text-xs-right">
	 						<input type="submit" class="btn btn-rounded btn-info mb-5" style="background-color: #224abe; padding:10px 20px" value="Ajouter">
						</div>
						</div>
					</form>
