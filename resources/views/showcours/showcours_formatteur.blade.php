                            ...
                            <div class="col-8" style="width:100%; padding-left: 50px">
                                ...
                                <div class="row">
                                    <div style="height: auto; display: block">
                                        <p style="font-size: 17px; white-space: pre-wrap; font-style:italic; color:#5b6378"> <span style="font-weight: bold">Formatteur :</span> <a style="color: black;" href="{{ route('formatteurprofile2', $showData->user['id']) }}">{{ $showData->user['name'] }}</a></p>
                                ...
                                <div class="card-body" style="border-radius:2px; padding-top: 50px; padding-bottom: 50px; padding-left: 60px; padding-right: 60px ; height:fit-content">
                                    <div class="row">
                                        ...
                                        <p style="font-size: 18px; white-space: pre-wrap ;color: black;"><i class="fas fa-fw fa-book"></i>   <span>{{$showData->matiere['name']}}</span></p>
                                            ...
                                            <p style="font-size: 18px; white-space: pre-wrap ;color: black;"><i class="fas fa-fw fa-book-reader"></i>   <a href="{{ route('subscribersview2', $showData->id) }}"><span>{{$enrolledcount}}</span></a></p>
                                            <p style="font-size: 18px; white-space: pre-wrap ;color: black;"><i class="fas fa-fw fa-comment"></i>   <a href="{{ route('commentsview2', $showData->id) }}"><span>{{$commentcount}}</span></a></p>
                                    </div>
                                </div>
                            </div> 
                        </div>
