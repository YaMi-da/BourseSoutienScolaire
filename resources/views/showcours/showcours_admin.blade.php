                            ...
                            <div class="col-8" style="width:100%; padding-left: 50px">
                                ...
                                <div class="row">
                                    <div  style="height: auto; display: block">
                                        <p style="font-size: 17px; white-space: pre-wrap; font-style:italic; color:#5b6378">Formatteur : <a style="color: black;" href="{{ route('formatteurprofile1', $showData->user['id']) }}">{{ $showData->user['name'] }}</a></p>
