    ...
    <div id="content">
        ...
        <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="margin-top: 50px; background-color: #d5e6ff">
                        ...
                        @endphp
                        <form method="POST" action="{{ route('commentspost1') }}">
                            @csrf
                                ...
                                <div class="col-md-10">
                                    <div class="media g-mb-30 media-comment">
                                        ...
                                        <ul class=" d-sm-flex my-0">
                                            ...
                                            <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="{{ route('deletecomment2', $comment->id) }}" id="delete">
