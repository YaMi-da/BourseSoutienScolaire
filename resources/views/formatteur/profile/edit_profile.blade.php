...
<div id="content-wrapper" class="d-flex flex-column">
    <div id="content">
	 ...
	 <form method="post" action="{{ route('formatteurprofile.store') }}" enctype="multipart/form-data">
	 	@csrf
					  <div class="row">
						<div class="col-12">	
...
<div class="row">
    ...
    <div class="col-md-6" >	
    <div class="form-group">
		<h5>Matiere <span class="text-danger">*</span></h5>
		<div class="controls">
	 <input type="text" name="matiere_formatteur" id="matiere" class="form-control" value="{{ $editData->matiere_formatteur }}" required="">  </div>
